...
Confirmado pelo usuário — sem espaço, corrigido em relação ao rascunho inicial.
...
**Decisão: Opção A** — o stream só funciona com o app em primeiro plano. Ao minimizar o app, o servidor para. Sem Foreground Service nesta versão (pode ser avaliado depois, se necessário).
